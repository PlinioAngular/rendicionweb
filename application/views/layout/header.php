      ...
      <li class="nav-item">
        ...
        <div id="collapseRendicion" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url()?>deposito">Rendiciones pendientes</a>
            <a class="collapse-item" href="<?php echo base_url()?>deposito/pendiente_validacion">Pendientes de Validación</a>
            <a class="collapse-item" href="<?php echo base_url()?>deposito/validas">Rendiciones Validadas</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url('rendicion/web_detalle/').md5($notificacion->idpersona); ?>">
                  <div class="mr-3">
                  ...
                  <div>
                    ...
                    <span class="font-weight-bold"><?php echo $notificacion->datos ; ?></span>
